...
or L<Term::ReadLine::Zoid> available.
...
Next, we'll assume you use B<vi> as your favorite editor. If you don't, skip
this section.

Two records are required in $HOME/.inputrc for maximum comfort:

  set editing-mode vi
  set keymap vi-insert

This will make sure that you're in B<insert mode> when C<re.pl> first is
started.
